###########../Data/USShapeFiles/Counties/co99_d00.shp:
...
USCounties_shp = os.path.abspath(os.path.join(os.path.dirname(__file__),'../../Data/USShapeFiles/Counties/co99_d00.shp'))

###########../Data/USShapeFiles/States/st99_d00.shp:
...
USStates_shp = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../Data/USShapeFiles/States/st99_d00.shp'))

###########../Data/USShapeFiles/FiveDigitZCTAs/zt01_d00.shp:
...
FiveDigitZCTAspath = os.path.abspath(os.path.join(os.path.dirname(__file__),'../../Data/USShapeFiles/FiveDigitZCTAs/'))

FiveDigitZCTAs_shp = [FiveDigitZCTAspath + '/' + x for x in os.listdir(FiveDigitZCTAspath) if x.endswith('.shp')]

###########../Data/USShapeFiles/MSA/cb99_03c.shp:
...
CBSA_shp = os.path.abspath(os.path.join(os.path.dirname(__file__),'../../Data/USShapeFiles/MSA/cb99_03c.shp'))


###########../Data/USShapeFiles/MSA/cs99_03c.shp:
...
CSA_shp = os.path.abspath(os.path.join(os.path.dirname(__file__),'../../Data/USShapeFiles/MSA/cs99_03c.shp'))



###########../Data/USShapeFiles/MSA/md99_03c.shp:
...
METDIV_shp = os.path.abspath(os.path.join(os.path.dirname(__file__),'../../Data/USShapeFiles/MSA/md99_03c.shp'))
...
CensusTractspath = os.path.abspath(os.path.join(os.path.dirname(__file__),'../../Data/USShapeFiles/CensusTracts/'))
...
CensusRegions_shp = os.path.abspath(os.path.join(os.path.dirname(__file__),'../../Data/USShapeFiles/CensusRegions/'))
...
CensusDivisions_shp = os.path.abspath(os.path.join(os.path.dirname(__file__),'../../Data/USShapeFiles/CensusDivisions/'))
