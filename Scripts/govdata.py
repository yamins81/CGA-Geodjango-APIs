...
root = '../Data/USShapeFiles/'
protocol_root = '../GeneratedCode/ShapeFiles/'
...
def ogrinspect(file,name):
	P = subprocess.Popen(['python ../Geodjango/manage.py ogrinspect ' + file + ' ' + name + ' --srid=4326 --mapping --multi'],stdout=subprocess.PIPE,shell=True)
